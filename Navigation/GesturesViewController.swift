...
final class GesturesViewController: UIViewController {
    ...
    private func setupView() {
        ...
        let centerXViewConstraint = self.secondView.centerXAnchor.constraint(equalTo: self.view.centerXAnchor)
        let centerYViewConstraint = self.secondView.centerYAnchor.constraint(equalTo: self.view.centerYAnchor)
        let widthViewConstraint = self.secondView.widthAnchor.constraint(equalToConstant: 250)
        let heightViewConstraint = self.secondView.heightAnchor.constraint(equalToConstant: 250)
    ...
    @objc private func handleTapGesture(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        UIView.animate(withDuration: 0.5) {
            self.secondView.alpha = self.isExpanded ? 0.5 : 0
